...
export const Footer = () => {
    ...
    <div className='footer text-center p-4 w-full flex items-center justify-around text-white'>
        <p className='text-xl w-1/4 font-semibold'>Leonel Barrientos. 2020-{d.getFullYear()}</p>
        <ul className='flex flex-row text-3xl cursor-pointer text-White w-3/4 items-center justify-evenly'>
          <li>
            <a href="https://github.com/leobarrientos02" target="_blank" rel="noreferrer">
              <FaGithub />
            </a>
          </li>
          <li>
            <a href="https://www.linkedin.com/in/leonel-barrientos-519b5a152/" target="_blank" rel="noreferrer">
              <FaLinkedin />
            </a>
          </li>
          <li>
