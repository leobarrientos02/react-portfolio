...
export const Contact = () => {
  ...
  return (
    <div className="contact w-full flex flex-col items-center">
      ...
      <div className='Box-Div w-2/3 flex py-2 flex-row items-center justify-evenly'>
        <motion.div  variants={ emailBadge } initial='hidden' animate='show' className="BOX flex flex-row items-center p-3 mx-2 border rounded-md bg-gray-200 shadow-xl shadow-red-200">
          <FiMail className='text-3xl text-red-400' /><span className="text-lg px-2 text-gray-700">leobarrientos02@gmail.com</span>
        </motion.div>
        <motion.div variants={ phoneBadge } initial='hidden' animate='show' className="BOX text-blue-500 flex flex-row items-center p-3 border rounded-md bg-gray-200 shadow-xl shadow-blue-200">
      ...
      <form action="https://formspree.io/f/xjvjonpb" method="POST" className='form w-full flex flex-col p-4 items-center'>
        <input 
          ...
          autoComplete='off'
          className='input w-1/2 p-2 bg-blue-100 text-lg text-gray-600 rounded-md shadow-md shadow-gray-300 outline-none'
        />
        <input 
          type="email" 
          name="_replyto"
        ...
        <textarea 
          ...
          rows="4"
          className='input w-1/2 p-2 bg-blue-100 text-base text-gray-600 font-mono rounded-md shadow-md shadow-gray-300 outline-none resize-none'
          >
        </textarea>
